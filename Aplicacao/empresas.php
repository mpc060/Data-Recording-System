...
<head>
    <meta charset="UTF-8">
    <title>Empresas - Solid Sistema de Gestão</title>
    <!-- CSS -->
...
<body>
    ...
    <table border="1">
       ...
       <tr>
          ...
          <td>
               <a href="edicao_empresa.php?id=<?=$empresa['id']?>">Editar</a>
               <a href="Server/cadastro_empresa_server.php?id=<?=$empresa['id']?>&operacao=exclusao">Remover</a>                   
            </td>
       </tr>
       <?php endforeach ?>  
    </table>
