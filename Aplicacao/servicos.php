...
<head>
    <meta charset="UTF-8">
    <title>Serviços - Solid Sistema de Gestão</title>
    <!-- CSS -->
...
<body>
    ...
    <table border="1">
       ...
       <tr>
          ...
          <td>
               <a href="edicao_servico.php?id=<?=$servico['id']?>">Editar</a>
               <a href="Server/cadastro_servico_server.php?id=<?=$servico['id']?>&operacao=exclusao">Remover</a>                   
            </td>
       </tr>
       <?php endforeach ?>  
    </table>
